 ...
 * generated in the ttu.idu0080.transportorderservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _OrderTransportResponse_QNAME = new QName("http://transportorderservice.idu0080.ttu/", "orderTransportResponse");
    private final static QName _OrderTransport_QNAME = new QName("http://transportorderservice.idu0080.ttu/", "orderTransport");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ttu.idu0080.transportorderservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://transportorderservice.idu0080.ttu/", name = "orderTransportResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://transportorderservice.idu0080.ttu/", name = "orderTransport")
