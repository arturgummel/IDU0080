 ...
 * 2015-04-15T10:39:43.802+03:00
 * Generated source version: 2.6.16
 * 
 */
@WebServiceClient(name = "OrderShipmentServiceService", 
                  wsdlLocation = "http://tund.ttu.ee/orderservice/order_shipments?wsdl",
...
public class OrderShipmentServiceService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://tund.ttu.ee/orderservice/order_shipments?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(OrderShipmentServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://tund.ttu.ee/orderservice/order_shipments?wsdl");
        }
        WSDL_LOCATION = url;
    }
