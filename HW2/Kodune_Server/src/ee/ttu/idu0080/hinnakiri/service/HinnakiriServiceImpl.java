...
public class HinnakiriServiceImpl implements HinnakiriService {
	...
	public GetHinnakiriResponse getHinnakiri(java.lang.String parameters)
			...
			HinnakiriNullNumberFormatException, HinnakiriAccuracyNumberFormatException {
		...
		if(!(parameters.matches("[0-9]+[.][0-9]{2}"))) {
			throw new HinnakiriAccuracyNumberFormatException();
		}
		try {
